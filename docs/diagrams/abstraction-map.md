...
| Presentation | Bubble themes | user/agent bubble shape, chrome placement *(#217 planned)* | [bubble-themes.md](./bubble-themes.md) |
...
- **#217** — bubble themes as an abstract class with overridable interface
