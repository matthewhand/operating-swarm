...
|---------|-------------|--------|
| **Fleet patterns (shared Success: remote prove, same-origin, health, herdr, hide, infra CI)** | #157 | [FLEET-PATTERNS.md](./FLEET-PATTERNS.md) |
| **Kind-chat e2e (auth + CLI/API/Blueprint/Team)** | #136 | [ISSUE-136-kind-chat-e2e.md](./ISSUE-136-kind-chat-e2e.md) |
...
|-----|---------|------|-----------|
| REQ-844 | Speech-bubble tails symmetric (#166) | [REQ-844-speech-bubble-symmetry.md](./REQ-844-speech-bubble-symmetry.md) | `tests/unit/test_req844_speech_bubble_symmetry.py` |
| REQ-845 | Composer never locks / offline queue (#167) | [REQ-845-composer-resilience.md](./REQ-845-composer-resilience.md) | `tests/unit/test_req845_composer_resilience.py` |
| REQ-846 | Team dropdown defaults CoS / first (#169) | [REQ-846-team-default-session.md](./REQ-846-team-default-session.md) | `tests/unit/test_req846_team_default_session.py` |
