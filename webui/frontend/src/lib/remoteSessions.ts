 ...
 * (Letta agents, Open WebUI chats, AnythingLLM threads, Hermes sessions). Resume key is the row ``id``.
 */
...
const SESSION_KINDS = new Set(['letta', 'openwebui', 'open-webui', 'open_webui', 'owui', 'anythingllm', 'hermes'])
