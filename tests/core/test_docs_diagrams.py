    ...
    [
        ...
        pytest.param(
            ...
            [
                ...
                "webui/frontend/src/lib/bubbleThemes/base.ts",
                "webui/frontend/src/lib/bubbleThemes/registry.ts",
                "webui/frontend/src/lib/bubbleThemes/themes.ts",
...
def test_diagram_names_real_classes_and_modules(
    ...
    for name in expected_names:
        assert re.search(rf"\b{re.escape(name)}\b", text), (
            ...
            "alongside the code change (#218 constraint)."
        )
